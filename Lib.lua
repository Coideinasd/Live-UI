...
return function(Config)
	...
	-- Lưu kích thước cũ khi maximize
	...
	local SearchIcon = New("ImageLabel", {
		...
		AnchorPoint = Vector2.new(0, 0.5),
		BackgroundTransparency = 1,
		Image = "rbxassetid://6031091010", -- search icon
		ImageColor3 = Color3.fromRGB(180, 180, 180),
	})

	SearchFrame.Parent = Window.Root
	...
	local DarkModeToggle = New("ImageButton", {
		...
		Position = UDim2.new(0, 0, 0, 0),
		BackgroundTransparency = 1,
		Image = "rbxassetid://6031091010", -- sẽ thay đổi
		ImageColor3 = Color3.fromRGB(180, 180, 180),
	})
	...
	-- Cập nhật icon cho các toggle
	local function UpdateToggleIcons()
		DarkModeToggle.Image = Window.DarkMode and "rbxassetid://6031091010" or "rbxassetid://6031091010" -- thay bằng icon bóng đèn
		SearchToggle.Image = Window.SearchVisible and "rbxassetid://6031091010" or "rbxassetid://6031091010" -- icon kính lúp
	end
	UpdateToggleIcons()
	...
	local function ApplyDarkMode(enable)
		if enable then
			...
			-- Các thành phần khác sẽ được cập nhật thông qua ThemeTag, nhưng nếu cần có thể set trực tiếp
		else
	...
	-- Method để set callback tìm kiếm
	...
	Window.Root = New("Frame", {
		...
		TabFrame,
		ResizeStartFrame,
		-- Thêm SearchFrame và ToggleFrame đã được tạo ở trên, nhưng chúng đã được gán Parent = Window.Root
	})
	...
	-- Sửa lỗi Maximize: đổi tên tham số Instant -> NoAnim để tránh xung đột
	...
	Creator.AddSignal(ResizeStartFrame.InputBegan, function(Input)
		if
			(Input.UserInputType == Enum.UserInputType.MouseButton1
			or Input.UserInputType == Enum.UserInputType.Touch)
			and not Window.Maximized -- không cho resize khi đang maximize
		then
			Resizing = true
	...
	-- Khởi tạo dark mode mặc định (có thể đặt true để mặc định dark)
	ApplyDarkMode(false) -- hoặc true tùy ý
